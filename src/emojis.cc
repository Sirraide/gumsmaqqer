...
const std::unordered_map<std::string, char32_t> sgtf = {
	...
	EMOJI("?¿", beverage_box),
	EMOJI("¿?", cup_with_straw),
	EMOJI("sCTWOHFIVEOH", sake),
	EMOJI("bCTWOHFIVEOH", beer),
	EMOJI("bbCTWOHFIVEOH", beers),
	EMOJI("cgCTWOHFIVEOH", champagne_glass),
	EMOJI("wCTWOHFIVEOH", wine_glass),
	EMOJI("tCTWOHFIVEOH", tumbler_glass),
	EMOJI("ckCTWOHFIVEOH", cocktail),
	EMOJI("trCTWOHFIVEOH", tropical_drink),
	EMOJI("cCTWOHFIVEOH", champagne),
	EMOJI("COLD", ice_cube),
